...
PieceSet::PieceSet()
{
	...
	apt[2].x = 0;    apt[2].y = 2;
	apt[3].x = 0;    apt[3].y = 3;
	pieces[0][0] = new Piece(0, 0, RGB(80, 188, 233), apt);
	...
	apt[2].x = 0;    apt[2].y = 1;
	apt[3].x = 0;    apt[3].y = 2;
	pieces[1][0] = new Piece(1, 0, RGB(255, 127, 0), apt);
	...
	apt[2].x = 1;    apt[2].y = 1;
	apt[3].x = 1;    apt[3].y = 2;
	pieces[2][0] = new Piece(2, 0, RGB(0, 0, 255), apt);
	...
	apt[2].x = 1;    apt[2].y = 1;
	apt[3].x = 2;    apt[3].y = 1;
	pieces[3][0] = new Piece(3, 0, RGB(0, 255, 0), apt);
	...
	apt[2].x = 0;    apt[2].y = 1;
	apt[3].x = 1;    apt[3].y = 1;
	pieces[4][0] = new Piece(4, 0, RGB(255, 0, 0), apt);
	...
	apt[2].x = 0;    apt[2].y = 1;
	apt[3].x = 1;    apt[3].y = 1;
	pieces[5][0] = new Piece(5, 0, RGB(255, 255, 0), apt);
	...
	apt[2].x = 2;    apt[2].y = 0;
	apt[3].x = 1;    apt[3].y = 1;
	pieces[6][0] = new Piece(6, 0, RGB(255, 0, 255), apt);
...
Piece* PieceSet::getRandomPiece()const
{
	return getPiece(rand() % NUM_PIECES, 0);
}